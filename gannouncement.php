...
echo "<td>";
echo'<a rel="facebox" href=editanno.php?id=' . $row2['annoId'] . '>' . '<img src="picture/editicon.png"/>' . '</a>';
echo'<a rel="facebox" href=deleteannoexec.php?id=' . $row2['annoId'] . '>' . '<img src="picture/deleteicon.png"/>' . '</a>';
echo "</td>";
echo "</tr>";
}?>
</tbody>
</table>
<a rel="facebox" name="answer" value="Add" href="addanno.php?id=<?php echo $row['userId'];?>" class="btn btn-danger" />Add</a>
